...
// Thu Mar 26 16:31:21 2015 by ROOT version 5.34/28
// from TTree Delphes/Analysis tree
// found on file: tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef DelphesClass_h
#define DelphesClass_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 937;
   const Int_t kMaxTrack = 133;
   const Int_t kMaxTower = 379;
   const Int_t kMaxEFlowTrack = 133;
   const Int_t kMaxEFlowPhoton = 207;
   const Int_t kMaxEFlowNeutralHadron = 154;
...
public :
   ...
   DelphesClass(TTree *tree=0);
   virtual ~DelphesClass();
...
#ifdef DelphesClass_cxx
DelphesClass::DelphesClass(TTree *tree) : fChain(0) 
{
...
DelphesClass::~DelphesClass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DelphesClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DelphesClass::LoadTree(Long64_t entry)
{
...
void DelphesClass::Init(TTree *tree)
{
...
void DelphesClass::Show(Long64_t entry)
{
...
Int_t DelphesClass::Cut(Long64_t entry)
{
